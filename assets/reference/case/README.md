...
| File | View | What it settles |
| --- | --- | --- |
| `front.jpg` | Straight down onto the front | The face texture; the wing/module outline; the angled shoulders where the module meets the wings |
| `front-oblique.jpg` | Front, from low and to one side | The module standing proud of the wings; the wings' front blocks |
| `back.jpg` | Straight down onto the back, the unit turned over about its short axis (its top edge at the image's bottom) | The back texture: diagonal ribs, label, the raised panel on each wing, the battery door, the four screw holes |
