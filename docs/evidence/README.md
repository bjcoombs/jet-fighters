...
| `console-model-board.jpg` | The model with its front shell off, rendered from a camera matched to `board-L1001568.jpg`, beside the photograph. Same check as the front. | Regenerate with `npm run model:render`. |
