...
def main(argv: list[str]) -> int:
    ...
    d.estimated("battery.count", 4, "The owner's testimony and photographs (case/bay-open.jpg, bay-empty.jpg): four AA cells.", 0.0)
    ...
    # The bay inside the housing: two cells side by side under the door and two
    ...
    d.estimated("shape.corner_radius", 2.5, "The wings' outer corners in plan: in case/front.jpg at about 10.4 px/mm the corner rounds over 25 px or so.", 1.0)
    d.estimated("shape.block_corner_radius", 6.0, "The raised stippled blocks' corners in plan, case/front.jpg; visibly rounder than the case's own corners.", 2.0)
    d.estimated("shape.edge_radius", 1.2, "The fillet along the shells' outer edges: the highlight band on the front face's edge in case/front.jpg is about 12 px wide, and end-left.jpg shows the same soft profile.", 0.5)
